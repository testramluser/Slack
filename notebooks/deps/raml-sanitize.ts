...
type SanitizeFunction = (check: any, key?: string, src?: ParameterValueMap) => any
type RuleFunction = (rule: any, key: string) => SanitizeFunction

type RulesObject = { [rule: string]: RuleFunction }
type TypesObject = { [rule: string]: SanitizeFunction }
