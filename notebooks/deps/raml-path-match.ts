...
type PathMatchFunction = (path: string) => PathMatchResult

function ramlPathMatch (path: string, parameters: Raml08Parser.NamedParameterMap, options: OptionsObject): PathMatchFunction {
    options = options || {}
